...
Requires a `BANKSYNC_API_KEY` environment variable. Get your API key at [banksync.io/developers](https://banksync.io/developers).
...
This package is a thin stdio-to-HTTP bridge. It validates your API key and forwards MCP messages to `https://mcp.banksync.io` via [mcp-remote](https://www.npmjs.com/package/mcp-remote). No financial data is stored locally.
